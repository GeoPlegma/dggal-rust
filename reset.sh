...
echo -e "The ECERE SYS crate" >> ecrt_sys/Cargo.toml
...
echo -e "The DGGAL SYS crate" >> ecrt_sys/Cargo.toml
...
echo 'ecrt_sys = { path = ./home/mj/CODE/gh/dggal-rust/dst/ecrt_sys" }' >> ./dggal_sys/Cargo.toml
...
echo -e "The DGGAL crate" >> ecrt_sys/Cargo.toml
...
echo 'ecrt_sys = { path = ./home/mj/CODE/gh/dggal-rust/dst/ecrt_sys" }' >> ./dggal/Cargo.toml
echo 'dggal_sys = { path = "/home/mj/CODE/gh/dggal-rust/dst/dggal_sys" }' >> ./dggal/Cargo.toml
