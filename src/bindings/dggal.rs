...
impl DGGAL {
    pub fn new(app: &Application) -> DGGAL {
        unsafe {
            DGGAL {
                mDGGAL: dggal_sys::dggal_init(app.app),
            }
        }
    }
}
...
impl DGGRS {
    pub fn new(dggal: &DGGAL, name: &str) -> Result<Self, String> {
        ...
        unsafe {
            let c = ecrt_sys::__eCNameSpace__eC__types__eSystem_FindClass(
                dggal.mDGGAL,
                dggrsName.as_ptr(),
            );
            if c != nullVTbl as *mut ecrt_sys::Class {
                Ok(DGGRS {
                    imp: ecrt_sys::__eCNameSpace__eC__types__eInstance_New(c) as dggal_sys::DGGRS,
                    mDGGAL: dggal.mDGGAL,
                })
            } else {
    ...
    pub fn getZoneFromTextID(&self, zoneID: &str) -> dggal_sys::DGGRSZone {
        ...
        unsafe {
            ...
            let vTbl = if self.imp != nullInst && (*self.imp)._vTbl != nullVTbl {
                (*self.imp)._vTbl
            } else {
                (*c)._vTbl
            };
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_getZoneFromTextID_vTblID as usize));
            if cMethod != 0usize {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    zoneID: *const i8,
                ) -> dggal_sys::DGGRSZone = std::mem::transmute(cMethod);
    ...
    pub fn getZoneLevel(&self, zone: dggal_sys::DGGRSZone) -> i32 {
        ...
        unsafe {
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_getZoneLevel_vTblID as usize));
            if cMethod != 0usize {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    zone: dggal_sys::DGGRSZone,
                ) -> i32 = std::mem::transmute(cMethod);
    ...
    pub fn countZoneEdges(&self, zone: dggal_sys::DGGRSZone) -> i32 {
        ...
        unsafe {
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_countZoneEdges_vTblID as usize));
            if cMethod != 0usize {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    zone: dggal_sys::DGGRSZone,
    ...
    pub fn getRefinementRatio(&self) -> i32 {
        ...
        unsafe {
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_getRefinementRatio_vTblID as usize));
            if cMethod != 0usize {
                let method: unsafe extern "C" fn(dggrs: dggal_sys::DGGRS) -> i32 =
                    std::mem::transmute(cMethod);
    ...
    pub fn getMaxDGGRSZoneLevel(&self) -> i32 {
        ...
        unsafe {
            ...
            let cMethod: usize = std::mem::transmute(
                *vTbl.add(dggal_sys::DGGRS_getMaxDGGRSZoneLevel_vTblID as usize),
            );
            if cMethod != 0usize {
                let method: unsafe extern "C" fn(dggrs: dggal_sys::DGGRS) -> i32 =
                    std::mem::transmute(cMethod);
    ...
    pub fn getZoneWGS84Centroid(&self, zone: dggal_sys::DGGRSZone) -> dggal_sys::GeoPoint {
        ...
        unsafe {
            ...
            let cMethod: usize = std::mem::transmute(
                *vTbl.add(dggal_sys::DGGRS_getZoneWGS84Centroid_vTblID as usize),
            );
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    zone: dggal_sys::DGGRSZone,
                    centroid: *mut dggal_sys::GeoPoint,
                ) = std::mem::transmute(cMethod);
    ...
    pub fn getZoneWGS84Vertices(&self, zone: dggal_sys::DGGRSZone) -> Vec<dggal_sys::GeoPoint> {
        ...
        unsafe {
            ...
            let cMethod: usize = std::mem::transmute(
                *vTbl.add(dggal_sys::DGGRS_getZoneWGS84Vertices_vTblID as usize),
            );
            let mut n: i32 = 0;
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    zone: dggal_sys::DGGRSZone,
                    vertices: *mut dggal_sys::GeoPoint,
                ) -> i32 = std::mem::transmute(cMethod);
    ...
    pub fn getZoneArea(&self, zone: dggal_sys::DGGRSZone) -> f64 {
        ...
        unsafe {
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_getZoneArea_vTblID as usize));
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    zone: dggal_sys::DGGRSZone,
                ) -> f64 = std::mem::transmute(cMethod);
    ...
    pub fn countSubZones(&self, zone: dggal_sys::DGGRSZone, depth: i32) -> u64 {
        ...
        unsafe {
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_countSubZones_vTblID as usize));
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    zone: dggal_sys::DGGRSZone,
                    depth: i32,
                ) -> u64 = std::mem::transmute(cMethod);
    ...
    pub fn getZoneTextID(&self, zone: dggal_sys::DGGRSZone) -> String {
        ...
        unsafe {
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_getZoneTextID_vTblID as usize));
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    zone: dggal_sys::DGGRSZone,
            ...
            id = CStr::from_ptr(zoneID.as_ptr())
                .to_str()
                .unwrap()
                .to_string();
        }
    ...
    pub fn getZoneParents(&self, zone: dggal_sys::DGGRSZone) -> Vec<dggal_sys::DGGRSZone> {
        ...
        unsafe {
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_getZoneParents_vTblID as usize));
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    zone: dggal_sys::DGGRSZone,
                    parents: *mut dggal_sys::DGGRSZone,
                ) -> i32 = std::mem::transmute(cMethod);
    ...
    pub fn getZoneChildren(&self, zone: dggal_sys::DGGRSZone) -> Vec<dggal_sys::DGGRSZone> {
        ...
        unsafe {
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_getZoneChildren_vTblID as usize));
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    zone: dggal_sys::DGGRSZone,
                    children: *mut dggal_sys::DGGRSZone,
                ) -> i32 = std::mem::transmute(cMethod);
    ...
    pub fn getZoneNeighbors(
        &self,
        zone: dggal_sys::DGGRSZone,
        nbTypes: &mut [i32; 6],
    ) -> Vec<dggal_sys::DGGRSZone> {
        let mut n: i32 = 0;
        ...
        unsafe {
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_getZoneNeighbors_vTblID as usize));
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    zone: dggal_sys::DGGRSZone,
                    neighbors: *mut dggal_sys::DGGRSZone,
                    nbTypes: *mut i32,
                ) -> i32 = std::mem::transmute(cMethod);
                n = method(
                    self.imp,
                    zone,
                    std::ptr::from_mut(&mut nb[0]),
                    std::ptr::from_mut(&mut nbTypes[0]),
                );
            }
    ...
    pub fn getZoneCentroidParent(&self, zone: dggal_sys::DGGRSZone) -> dggal_sys::DGGRSZone {
        ...
        unsafe {
            ...
            let cMethod: usize = std::mem::transmute(
                *vTbl.add(dggal_sys::DGGRS_getZoneCentroidParent_vTblID as usize),
            );
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
    ...
    pub fn getZoneCentroidChild(&self, zone: dggal_sys::DGGRSZone) -> dggal_sys::DGGRSZone {
        ...
        unsafe {
            ...
            let cMethod: usize = std::mem::transmute(
                *vTbl.add(dggal_sys::DGGRS_getZoneCentroidChild_vTblID as usize),
            );
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
    ...
    pub fn isZoneCentroidChild(&self, zone: dggal_sys::DGGRSZone) -> bool {
        ...
        unsafe {
            ...
            let cMethod: usize = std::mem::transmute(
                *vTbl.add(dggal_sys::DGGRS_isZoneCentroidChild_vTblID as usize),
            );
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    zone: dggal_sys::DGGRSZone,
                ) -> u32 = std::mem::transmute(cMethod);
    ...
    pub fn getZoneWGS84Extent(&self, zone: dggal_sys::DGGRSZone) -> dggal_sys::GeoExtent {
        let mut extent: dggal_sys::GeoExtent = dggal_sys::GeoExtent {
            // REVIEW: Any way to avoid this initialization?
        ...
        unsafe {
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_getZoneWGS84Extent_vTblID as usize));
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    zone: dggal_sys::DGGRSZone,
                    extent: *mut dggal_sys::GeoExtent,
                ) = std::mem::transmute(cMethod);
    ...
    pub fn listZones(&self, level: i32, bbox: &dggal_sys::GeoExtent) -> Vec<dggal_sys::DGGRSZone> {
        ...
        unsafe {
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_listZones_vTblID as usize));
            let mut n: usize = 0;
            ...
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    level: i32,
                    bbox: *const dggal_sys::GeoExtent,
                )
                    -> dggal_sys::template_Array_DGGRSZone = std::mem::transmute(cMethod);
                let az: dggal_sys::template_Array_DGGRSZone = method(self.imp, level, bbox);
                if az != nullInst {
                    let am: *const ecrt_sys::class_members_Array = ((az as *const i8)
                        .wrapping_add((*ecrt_sys::class_Array).offset as usize))
                        as *const ecrt_sys::class_members_Array;
                    n = (*am).count as usize;
                    a = (*am).array;
                }
            }
    ...
    pub fn getZoneRefinedWGS84Vertices(
        &self,
        zone: dggal_sys::DGGRSZone,
        refinement: i32,
    ) -> Vec<dggal_sys::GeoPoint> {
        let vertices: Vec<dggal_sys::GeoPoint>;
        unsafe {
            let c = dggal_sys::class_DGGRS;
            let vTbl = if self.imp != nullInst && (*self.imp)._vTbl != nullVTbl {
            ...
            let cMethod: usize = std::mem::transmute(
                *vTbl.add(dggal_sys::DGGRS_getZoneRefinedWGS84Vertices_vTblID as usize),
            );
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    ...
                    -> dggal_sys::template_Array_GeoPoint = std::mem::transmute(cMethod);
                let ap: dggal_sys::template_Array_GeoPoint = method(self.imp, zone, refinement);
                if ap != nullInst {
                    let am: *const ecrt_sys::class_members_Array = ((ap as *const i8)
                        .wrapping_add((*ecrt_sys::class_Array).offset as usize))
                        as *const ecrt_sys::class_members_Array;
                    n = (*am).count as usize;
    ...
    pub fn getSubZones(
        ...
        unsafe {
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_getSubZones_vTblID as usize));
            let mut n: usize = 0;
            let mut a: *const dggal_sys::DGGRSZone = nullPtr as *const dggal_sys::DGGRSZone;
            ...
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(
                    ...
                    -> dggal_sys::template_Array_DGGRSZone = std::mem::transmute(cMethod);
                let az: dggal_sys::template_Array_DGGRSZone =
                    method(self.imp, parent, relativeDepth);
                if az != nullInst {
                    let am: *const ecrt_sys::class_members_Array = ((az as *const i8)
                        .wrapping_add((*ecrt_sys::class_Array).offset as usize))
                        as *const ecrt_sys::class_members_Array;
    ...
    pub fn getZoneFromWGS84Centroid(
        &self,
        level: i32,
        centroid: &dggal_sys::GeoPoint,
    ) -> dggal_sys::DGGRSZone {
        let mut zone = nullZone;
        unsafe {
            let c = dggal_sys::class_DGGRS;
            ...
            let cMethod: usize = std::mem::transmute(
                *vTbl.add(dggal_sys::DGGRS_getZoneFromWGS84Centroid_vTblID as usize),
            );
            if cMethod != 0usize {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    level: i32,
                    centroid: *const dggal_sys::GeoPoint,
                ) -> dggal_sys::DGGRSZone = std::mem::transmute(cMethod);
    ...
    pub fn getZoneFromCRSCentroid(
        &self,
        level: i32,
        crs: CRS,
        centroid: &ecrt_sys::Pointd,
    ) -> dggal_sys::DGGRSZone {
        let mut zone = nullZone;
        unsafe {
            let c = dggal_sys::class_DGGRS;
            ...
            let cMethod: usize = std::mem::transmute(
                *vTbl.add(dggal_sys::DGGRS_getZoneFromCRSCentroid_vTblID as usize),
            );
            if cMethod != 0usize {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    level: i32,
                    crs: dggal_sys::CRS,
                    centroid: *const ecrt_sys::Pointd,
                ) -> dggal_sys::DGGRSZone = std::mem::transmute(cMethod);
    ...
    pub fn countZones(&self, level: i32) -> u64 {
        ...
        unsafe {
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_countZones_vTblID as usize));
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(dggrs: dggal_sys::DGGRS, level: i32) -> u64 =
                    std::mem::transmute(cMethod);
    ...
    pub fn getFirstSubZone(
        ...
        unsafe {
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_getFirstSubZone_vTblID as usize));
            if cMethod != 0usize {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    parent: dggal_sys::DGGRSZone,
    ...
    pub fn getIndexMaxDepth(&self) -> i32 {
        ...
        unsafe {
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_getIndexMaxDepth_vTblID as usize));
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(dggrs: dggal_sys::DGGRS) -> i32 =
                    std::mem::transmute(cMethod);
    ...
    pub fn getMaxChildren(&self) -> i32 {
        ...
        unsafe {
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_getMaxChildren_vTblID as usize));
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(dggrs: dggal_sys::DGGRS) -> i32 =
                    std::mem::transmute(cMethod);
    ...
    pub fn getMaxNeighbors(&self) -> i32 {
        ...
        unsafe {
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_getMaxNeighbors_vTblID as usize));
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(dggrs: dggal_sys::DGGRS) -> i32 =
                    std::mem::transmute(cMethod);
    ...
    pub fn getMaxParents(&self) -> i32 {
        ...
        unsafe {
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_getMaxParents_vTblID as usize));
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(dggrs: dggal_sys::DGGRS) -> i32 =
                    std::mem::transmute(cMethod);
    ...
    pub fn getSubZoneAtIndex(
        ...
        unsafe {
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_getSubZoneAtIndex_vTblID as usize));
            if cMethod != 0usize {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    parent: dggal_sys::DGGRSZone,
    ...
    pub fn getSubZoneIndex(
        &self,
        parent: dggal_sys::DGGRSZone,
        subZone: dggal_sys::DGGRSZone,
    ) -> i64 {
        let mut index = -1;
        unsafe {
            let c = dggal_sys::class_DGGRS;
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_getSubZoneIndex_vTblID as usize));
            if cMethod != 0usize {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    parent: dggal_sys::DGGRSZone,
                    subZone: dggal_sys::DGGRSZone,
                ) -> i64 = std::mem::transmute(cMethod);
    ...
    pub fn getSubZoneCRSCentroids(
        ...
        unsafe {
            ...
            let cMethod: usize = std::mem::transmute(
                *vTbl.add(dggal_sys::DGGRS_getSubZoneCRSCentroids_vTblID as usize),
            );
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    ...
                    -> dggal_sys::template_Array_Pointd = std::mem::transmute(cMethod);
                let ap: dggal_sys::template_Array_Pointd =
                    method(self.imp, parent, *crs, relativeDepth);
                if ap != nullInst {
                    let am: *const ecrt_sys::class_members_Array = ((ap as *const i8)
                        .wrapping_add((*ecrt_sys::class_Array).offset as usize))
                        as *const ecrt_sys::class_members_Array;
    ...
    pub fn getSubZoneWGS84Centroids(
        &self,
        parent: dggal_sys::DGGRSZone,
        relativeDepth: i32,
    ) -> Vec<dggal_sys::GeoPoint> {
        ...
        unsafe {
            ...
            let cMethod: usize = std::mem::transmute(
                *vTbl.add(dggal_sys::DGGRS_getSubZoneWGS84Centroids_vTblID as usize),
            );
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    ...
                    -> dggal_sys::template_Array_GeoPoint = std::mem::transmute(cMethod);
                let ap: dggal_sys::template_Array_GeoPoint =
                    method(self.imp, parent, relativeDepth);
                if ap != nullInst {
                    let am: *const ecrt_sys::class_members_Array = ((ap as *const i8)
                        .wrapping_add((*ecrt_sys::class_Array).offset as usize))
    ...
    pub fn getZoneCRSVertices(
        ...
        unsafe {
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_getZoneCRSVertices_vTblID as usize));
            let mut n: i32 = 0;
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
    ...
    pub fn getZoneRefinedCRSVertices(
        &self,
        zone: dggal_sys::DGGRSZone,
        crs: CRS,
        refinement: i32,
        ...
        unsafe {
            ...
            let cMethod: usize = std::mem::transmute(
                *vTbl.add(dggal_sys::DGGRS_getZoneRefinedCRSVertices_vTblID as usize),
            );
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    ...
                    -> dggal_sys::template_Array_GeoPoint = std::mem::transmute(cMethod);
                let ap: dggal_sys::template_Array_GeoPoint =
                    method(self.imp, zone, *crs, refinement);
                if ap != nullInst {
                    let am: *const ecrt_sys::class_members_Array = ((ap as *const i8)
                        .wrapping_add((*ecrt_sys::class_Array).offset as usize))
                        as *const ecrt_sys::class_members_Array;
    ...
    pub fn getZoneCRSCentroid(&self, zone: dggal_sys::DGGRSZone, crs: CRS) -> ecrt_sys::Pointd {
        ...
        unsafe {
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_getZoneCRSCentroid_vTblID as usize));
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    zone: dggal_sys::DGGRSZone,
                    crs: dggal_sys::CRS,
                    centroid: *mut ecrt_sys::Pointd,
                ) = std::mem::transmute(cMethod);
    ...
    pub fn getZoneCRSExtent(&self, zone: dggal_sys::DGGRSZone, crs: CRS) -> dggal_sys::CRSExtent {
        let mut extent: dggal_sys::CRSExtent = dggal_sys::CRSExtent {
            // REVIEW: Any way to avoid this initialization?
        ...
        unsafe {
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_getZoneCRSExtent_vTblID as usize));
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    zone: dggal_sys::DGGRSZone,
                    crs: dggal_sys::CRS,
                    extent: *mut dggal_sys::CRSExtent,
                ) = std::mem::transmute(cMethod);
    ...
    pub fn compactZones(&self, zones: &mut Vec<dggal_sys::DGGRSZone>) {
        unsafe {
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_compactZones_vTblID as usize));
            if cMethod != std::mem::transmute(0usize) {
                let mut n: usize = zones.len();
                if n != 0 {
                    let method: unsafe extern "C" fn(
                        dggrs: dggal_sys::DGGRS,
                        zones: dggal_sys::template_Array_DGGRSZone,
                    ) = std::mem::transmute(cMethod);
                    let ac = ecrt_sys::__eCNameSpace__eC__types__eSystem_FindClass(
                        self.mDGGAL,
                        "Array<DGGRSZone>\0".as_ptr() as *const i8,
                    );
                    let az: dggal_sys::template_Array_DGGRSZone =
                        ecrt_sys::__eCNameSpace__eC__types__eInstance_New(ac)
                            as dggal_sys::template_Array_DGGRSZone;
                    let am: *const ecrt_sys::class_members_Array;
                    let mut a: *mut dggal_sys::DGGRSZone;

                    ecrt_sys::Array_set_size.unwrap()(az, n as u32);
                    am = ((az as *const i8).wrapping_add((*ecrt_sys::class_Array).offset as usize))
                        as *const ecrt_sys::class_members_Array;
                    a = (*am).array as *mut dggal_sys::DGGRSZone;
                    ecrt_sys::memcpy(
                        a as *mut c_void,
                        zones.as_ptr() as *const c_void,
                        (mem::size_of::<dggal_sys::DGGRSZone>() * n) as std::os::raw::c_ulong,
                    );
                    method(self.imp, az);
    ...
    pub fn zoneHasSubZone(
        &self,
        hayStack: dggal_sys::DGGRSZone,
        needle: dggal_sys::DGGRSZone,
    ) -> bool {
        let mut result: bool = false;
        unsafe {
            let c = dggal_sys::class_DGGRS;
            ...
            let cMethod: usize =
                std::mem::transmute(*vTbl.add(dggal_sys::DGGRS_zoneHasSubZone_vTblID as usize));
            if cMethod != std::mem::transmute(0usize) {
                let method: unsafe extern "C" fn(
                    dggrs: dggal_sys::DGGRS,
                    hayStack: dggal_sys::DGGRSZone,
    ...
    pub fn isZoneAncestorOf(
        &self,
        ancestor: dggal_sys::DGGRSZone,
        descendant: dggal_sys::DGGRSZone,
        maxDepth: i32,
    ) -> bool {
        let mut result: bool = false;
        unsafe {
            if self.imp != nullInst {
                result = dggal_sys::DGGRS_isZoneAncestorOf.unwrap()(
                    self.imp, ancestor, descendant, maxDepth,
                ) != 0;
            }
        }
        result
    ...
    pub fn isZoneContainedIn(
        ...
        unsafe {
            if self.imp != nullInst {
                result =
                    dggal_sys::DGGRS_isZoneContainedIn.unwrap()(self.imp, needle, hayStack) != 0;
            }
        }
        result
    }

    pub fn isZoneDescendantOf(
        &self,
        descendant: dggal_sys::DGGRSZone,
        ancestor: dggal_sys::DGGRSZone,
        maxDepth: i32,
        ...
        unsafe {
            if self.imp != nullInst {
                result = dggal_sys::DGGRS_isZoneDescendantOf.unwrap()(
                    self.imp, descendant, ancestor, maxDepth,
                ) != 0;
            }
        }
        result
    ...
    pub fn isZoneImmediateChildOf(
        &self,
        child: dggal_sys::DGGRSZone,
        parent: dggal_sys::DGGRSZone,
    ) -> bool {
        let mut result: bool = false;
        unsafe {
            if self.imp != nullInst {
                result =
                    dggal_sys::DGGRS_isZoneImmediateChildOf.unwrap()(self.imp, child, parent) != 0;
            }
        }
        result
    }

    pub fn isZoneImmediateParentOf(
        &self,
        parent: dggal_sys::DGGRSZone,
        child: dggal_sys::DGGRSZone,
    ) -> bool {
        ...
        unsafe {
            if self.imp != nullInst {
                result =
                    dggal_sys::DGGRS_isZoneImmediateParentOf.unwrap()(self.imp, parent, child) != 0;
            }
        }
        result
    }

    pub fn getLevelFromMetersPerSubZone(
        &self,
        ...
        unsafe {
            if self.imp != nullInst {
                result = dggal_sys::DGGRS_getLevelFromMetersPerSubZone.unwrap()(
                    self.imp,
    ...
    pub fn getLevelFromPixelsAndExtent(
        &self,
        extent: &dggal_sys::GeoExtent,
        pixels: &ecrt_sys::Point,
        relativeDepth: i32,
    ) -> i32 {
        let mut result: i32 = 0;
        unsafe {
            if self.imp != nullInst {
                result = dggal_sys::DGGRS_getLevelFromPixelsAndExtent.unwrap()(
                    self.imp,
                    extent,
                    pixels,
                    relativeDepth,
    ...
    pub fn getLevelFromScaleDenominator(
        &self,
        ...
        unsafe {
            if self.imp != nullInst {
                result = dggal_sys::DGGRS_getLevelFromScaleDenominator.unwrap()(
                    self.imp,
                    scaleDenominator,
                    relativeDepth,
                    mmPerPixel,
    ...
    pub fn getMetersPerSubZoneFromLevel(&self, parentLevel: i32, relativeDepth: i32) -> f64 {
        ...
        unsafe {
            if self.imp != nullInst {
                result = dggal_sys::DGGRS_getMetersPerSubZoneFromLevel.unwrap()(
                    self.imp,
                    parentLevel,
                    relativeDepth,
                );
    ...
    pub fn getScaleDenominatorFromLevel(
        &self,
        parentLevel: i32,
        relativeDepth: i32,
        mmPerPixel: f64,
        ...
        unsafe {
            if self.imp != nullInst {
                result = dggal_sys::DGGRS_getScaleDenominatorFromLevel.unwrap()(
                    self.imp,
                    parentLevel,
                    relativeDepth,
                    mmPerPixel,
...
impl DGGSJSONDepth {
    pub fn data(&self) -> Array<FieldValue> {
        ...
        if self.0 .0 != nullInst {
            unsafe {
                let members: *const dggal_sys::class_members_DGGSJSONDepth = ((self.0 .0
                    as *const i8)
                    .wrapping_add((*dggal_sys::class_DGGSJSONDepth).offset as usize))
                    as *const dggal_sys::class_members_DGGSJSONDepth;
...
impl DGGSJSON {
    pub fn dggrs(&self) -> ConstString {
        ...
        if self.0 .0 != nullInst {
            unsafe {
                let members: *const dggal_sys::class_members_DGGSJSON = ((self.0 .0 as *const i8)
                    .wrapping_add((*dggal_sys::class_DGGSJSON).offset as usize))
                    as *const dggal_sys::class_members_DGGSJSON;
