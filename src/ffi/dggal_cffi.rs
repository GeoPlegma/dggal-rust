...
extern "C" {
    pub static mut DGGRS_doesZoneContain: ::std::option::Option<
        /*unsafe*/
        extern "C" fn(__this: DGGRS, hayStack: DGGRSZone, needle: DGGRSZone) -> bool_,
    >;
}
/*unsafe*/
extern "C" {
    pub static mut DGGRS_get64KDepth: ::std::option::Option<
        /*unsafe*/ extern "C" fn(__this: DGGRS) -> ::std::os::raw::c_int,
    >;
}
/*unsafe*/
extern "C" {
...
/*unsafe*/
extern "C" {
    pub static mut DGGRS_getMaxDepth: ::std::option::Option<
        /*unsafe*/ extern "C" fn(__this: DGGRS) -> ::std::os::raw::c_int,
    >;
}
/*unsafe*/
...
extern "C" {
    pub static mut DGGRS_isZoneContainedIn: ::std::option::Option<
        /*unsafe*/
        extern "C" fn(__this: DGGRS, needle: DGGRSZone, hayStack: DGGRSZone) -> bool_,
    >;
}
/*unsafe*/
extern "C" {
...
extern "C" {
    pub static mut DGGRS_isZoneImmediateChildOf: ::std::option::Option<
        /*unsafe*/
        extern "C" fn(__this: DGGRS, child: DGGRSZone, parent: DGGRSZone) -> bool_,
    >;
}
/*unsafe*/
extern "C" {
    pub static mut DGGRS_isZoneImmediateParentOf: ::std::option::Option<
        /*unsafe*/
        extern "C" fn(__this: DGGRS, parent: DGGRSZone, child: DGGRSZone) -> bool_,
    >;
}
/*unsafe*/
extern "C" {
...
/*unsafe*/
extern "C" {
    pub static mut GeoExtent_doUnionDL: ::std::option::Option<
        /*unsafe*/ extern "C" fn(__this: *mut GeoExtent, e: *const GeoExtent),
    >;
}
/*unsafe*/
extern "C" {
...
/*unsafe*/
extern "C" {
    pub static mut JSONSchema_get_maxItems: ::std::option::Option<
        /*unsafe*/ extern "C" fn(j: JSONSchema) -> ::std::os::raw::c_int,
    >;
}
/*unsafe*/
extern "C" {
...
/*unsafe*/
extern "C" {
    pub static mut JSONSchema_get_minItems: ::std::option::Option<
        /*unsafe*/ extern "C" fn(j: JSONSchema) -> ::std::os::raw::c_int,
    >;
}
/*unsafe*/
...
/*unsafe*/
extern "C" {
    pub static mut JSONSchema_get_maxProperties: ::std::option::Option<
        /*unsafe*/ extern "C" fn(j: JSONSchema) -> ::std::os::raw::c_int,
    >;
}
/*unsafe*/
...
/*unsafe*/
extern "C" {
    pub static mut JSONSchema_get_minProperties: ::std::option::Option<
        /*unsafe*/ extern "C" fn(j: JSONSchema) -> ::std::os::raw::c_int,
    >;
}
/*unsafe*/
...
/*unsafe*/
extern "C" {
    pub static mut RI5x6Projection_fromIcosahedronNet: ::std::option::Option<
        /*unsafe*/ extern "C" fn(v: *const Pointd, result: *mut Pointd) -> bool_,
    >;
}
/*unsafe*/
extern "C" {
...
/*unsafe*/
extern "C" {
    pub static mut RI5x6Projection_toIcosahedronNet: ::std::option::Option<
        /*unsafe*/ extern "C" fn(v: *const Pointd, result: *mut Pointd) -> bool_,
    >;
}
/*unsafe*/
extern "C" {
    pub static mut Vector3D_crossProduct: ::std::option::Option<
        /*unsafe*/
        extern "C" fn(__this: *mut Vector3D, vector1: *const Vector3D, vector2: *const Vector3D),
    >;
}
/*unsafe*/
extern "C" {
...
extern "C" {
    pub static mut Vector3D_multQuaternion: ::std::option::Option<
        /*unsafe*/
        extern "C" fn(__this: *mut Vector3D, s: *const Vector3D, quat: *const Quaternion),
    >;
}
/*unsafe*/
extern "C" {
    pub static mut Vector3D_normalize: ::std::option::Option<
        /*unsafe*/ extern "C" fn(__this: *mut Vector3D, source: *const Vector3D),
    >;
}
/*unsafe*/
extern "C" {
...
/*unsafe*/
extern "C" {
    pub static mut Z7Zone_getParentRotationOffset: ::std::option::Option<
        /*unsafe*/ extern "C" fn(zone: I7HZone) -> ::std::os::raw::c_int,
    >;
}
/*unsafe*/
extern "C" {
...
/*unsafe*/
extern "C" {
    pub static mut authalicSetup: ::std::option::Option<
        /*unsafe*/ extern "C" fn(a: f64, b: f64, cp: *mut [f64; 6usize]),
    >;
}
/*unsafe*/
extern "C" {
...
extern "C" {
    pub static mut compactGGGZones: ::std::option::Option<
        /*unsafe*/
        extern "C" fn(zones: Array, start: ::std::os::raw::c_int, maxLevel: ::std::os::raw::c_int),
    >;
}
/*unsafe*/
extern "C" {
    pub static mut latAuthalicToGeodetic: ::std::option::Option<
        /*unsafe*/ extern "C" fn(cp: *const [f64; 6usize], phi: Angle) -> Angle,
    >;
}
/*unsafe*/
extern "C" {
    pub static mut latGeodeticToAuthalic: ::std::option::Option<
        /*unsafe*/ extern "C" fn(cp: *const [f64; 6usize], phi: Angle) -> Angle,
    >;
}
/*unsafe*/
extern "C" {
    pub static mut fnptr_readDGGSJSON:
        ::std::option::Option</*unsafe*/ extern "C" fn(f: File) -> DGGSJSON>;
}
/*unsafe*/
extern "C" {
